...
async function validarSistema() {
    try {
        ...
        const response = await fetch(window.location.origin + '/api/sistemas-ecuaciones/validar-sistema', {
            method: 'POST',
            headers: {
...
async function resolverSistema() {
    ...
    try {
        ...
        const response = await fetch(window.location.origin + '/api/sistemas-ecuaciones/gauss-pivoteo', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
